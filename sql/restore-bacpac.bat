...
set sqlpackage_path="c:\Tools\SqlPackage\sqlpackage-win7-x64-en-16.0.6161.0\sqlpackage.exe"
set bacpac_path="w:\_git\_owned\azure-sql-db-who-am-i\sql\who-am-i-db\bin\Debug\who-am-i-db.dacpac"
